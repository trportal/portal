...
CHANNELS = [
    {
        ...
        # PLACEHOLDER — this invite link has no @username, so get_chat_member
        # needs the real numeric chat ID here instead, e.g. "-1001234567890".
        # Bot must be admin in the channel first. Easiest way to get the ID:
    ...
    {"label": "Etcold",   "chat_id": "@etcold",    "join_url": "https://t.me/etcold"},
]

WELCOME_MESSAGE = (
    "<b>🔒 CONTENT LOCKED</b>\n"
    "<code>━━━━━━━━━━━━━━━━━━━━</code>\n\n"
    "You're <b>one step away</b> from the full guide.\n\n"
    "<blockquote><b>Unlock it in 3 steps</b>\n"
    "1️⃣ Join <b>all</b> the channels below\n"
    "2️⃣ Tap <b>✅ Verify</b>\n"
    "3️⃣ Guide lands in your DMs instantly</blockquote>\n"
    "⚠️ <i>Leaving a channel after verifying will revoke access.</i>\n\n"
    "<code>━━━━━━━━━━━━━━━━━━━━</code>\n"
...
SUCCESS_MESSAGE = (
    ...
    "Sending your guide now — check your DMs 📩\n\n"
    "<code>━━━━━━━━━━━━━━━━━━━━</code>\n"
...
GUIDE_LINK = "https://t.me/+O9yHNTDOZXJiNDE1"
GUIDE_CAPTION = (
...
def build_keyboard(show_retry: bool = False) -> InlineKeyboardMarkup:
    ...
    label = "🔄 VERIFY AGAIN" if show_retry else "✅ VERIFY NOW"
